...
setup(
    ...
    ext_modules=[
        ...
        Extension('gensim.models.time2vec_inner',
            sources=['./gensim/models/time2vec_inner.c'],
            include_dirs=[model_dir]),
        Extension('gensim.models.smsg_inner',
            sources=['./gensim/models/smsg_inner.c'],
            include_dirs=[model_dir]),
        Extension('gensim.models.dory_inner',
            sources=['./gensim/models/dory_inner.c'],
            include_dirs=[model_dir]),
        Extension('gensim.models.ppmi_inner',
            sources=['./gensim/models/ppmi_inner.c'],
            include_dirs=[model_dir]),
    ],
    cmdclass=cmdclass,
